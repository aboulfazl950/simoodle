...
/**
 * Strings for component 'choice', language 'fa', version '4.5'.
 *
 * @package     choice
 * @category    string
...
$string['chooseoption'] = 'انتخاب: {$a}';
$string['completiondetail:submit'] = 'انتخاب یک گزینه';
...
$string['previewing'] = 'این فقط پیش نمایشی از گزینه‌های موجود برای این فعالیت است. وقتی باز شد می‌توانید انتخاب کنید.';
...
$string['publishinfoanonafter'] = 'نتایج بعد از پاسخ‌دهی شما به صورت ناشناس منتشر خواهد شد.';
$string['publishinfonever'] = 'نتایج این فعالیت بعد از پاسخ شما منتشر نخواهد شد.';
...
$string['viewchoices'] = 'مشاهده انتخاب‌ها';
