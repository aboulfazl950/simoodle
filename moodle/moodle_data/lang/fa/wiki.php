...
/**
 * Strings for component 'wiki', language 'fa', version '4.5'.
 *
 * @package     wiki
 * @category    string
...
$string['invalidsesskey'] = 'به احتمال زیاد زمان نشست کاری شما به پایان رسیده است. لطفاً ویرایش خود را جایی یادداشت کنید سپس دوباره وارد شوید.';
