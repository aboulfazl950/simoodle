...
/**
 * Strings for component 'local_bulkenrol', language 'fa', version '4.5'.
 *
...
$string['bulkenrol_form_intro'] = 'اینجا، شما می‌توانید کاربران را در درس ثبت‌نام کنید. کاربری که قرار است ثبت‌نام شود، بر اساس ایمیل ذخیره‌شده در حساب کاربری مودل خود شناسایی می‌شود.';
