...
/**
 * Strings for component 'auth_email', language 'fa', version '4.5'.
 *
 * @package     auth_email
 * @category    string
...
$string['privacy:metadata'] = 'پلاگین شناسایی Email-based self-registration هیچ اطلاعات شخصی‌ای ذخیره نمی‌کند.';
