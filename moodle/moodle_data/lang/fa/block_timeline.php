...
/**
 * Strings for component 'block_timeline', language 'fa', version '4.5'.
 *
...
$string['ariaeventlistitem'] = 'موعد تحویل فعالیت {$a->name} در درس {$a->course} تاریخ {$a->date} است';
