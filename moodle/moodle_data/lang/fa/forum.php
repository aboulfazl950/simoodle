...
/**
 * Strings for component 'forum', language 'fa', version '4.5'.
 *
 * @package     forum
 * @category    string
...
$string['activitydate:due'] = 'مهلت:';
$string['activityoverview'] = 'مطلب جدیدی در تالار گفتگو نیست';
$string['addanewdiscussion'] = 'شروع یک گفتگوی جدید';
$string['addanewquestion'] = 'طرح یک سؤال جدید';
$string['addanewtopic'] = 'اضافه کردن یک موضوع جدید';
$string['addtofavourites'] = 'ستاره‌دار کردن این گفتگو';
...
$string['alreadyfirstpost'] = 'این مطلب، خود اولین مطلب بیان شده در این گفتگو است';
...
$string['cannotadd'] = 'اضافه شدن گفتگو به این تالار انجام نشد';
$string['cannotadddiscussion'] = 'طرح گفتگو در این تالار نیازمند عضویت در گروه است.';
$string['cannotadddiscussionall'] = 'شما مجوز شروع کردن یک گفتگوی جدید برای همهٔ اعضا را ندارید.';
...
$string['cannotcreatediscussion'] = 'ایجاد گفتگوی جدید ممکن نشد';
...
$string['cannotfinddiscussion'] = 'گفتگوی مورد نظر در این تالار پیدا نشد';
...
$string['cannotmovefromsingleforum'] = 'انتقال گفتگو از یک تالار تک مبحثی ممکن نیست';
$string['cannotmovenotvisible'] = 'این تالار توسط شما قابل مشاهده نیست';
$string['cannotmovetonotexist'] = 'تالار انتخاب شده وجود ندارد. نمی‌توانید گفتگو را به آن منتقل کنید!';
$string['cannotmovetonotfound'] = 'تالار مقصد در این درس پیدا نشد.';
$string['cannotmovetosingleforum'] = 'نمی‌توان گفتگو را به یک تالار تک مبحثی ساده منتقل کرد';
...
$string['cannotsplit'] = 'گفتگوهای این تالار را نمی‌شود تقسیم کرد';
...
$string['cannotviewpostyet'] = 'چون هنوز مطلبی نفرستاده‌اید نمی‌توانید  سؤالات دیگران را در این گفتگو ببینید';
...
$string['clicktolockdiscussion'] = 'برای قفل کردن این گفتگو کلیک کنید';
$string['clicktosubscribe'] = 'شما آبونهٔ این گفتگو نیستید. برای آبونه‌شدن کلیک کنید.';
$string['clicktounlockdiscussion'] = 'برای باز کردن قفل این گفتگو کلیک کنید';
$string['clicktounsubscribe'] = 'شما آبونهٔ این گفتگو هستید. برای لغو اشتراک کلیک کنید.';
$string['close'] = 'بستن';
$string['closegrader'] = 'بستن نمره‌گذار';
$string['completiondetail:discussions'] = 'شروع {$a} گفتگو';
$string['completiondetail:posts'] = 'ارسال {$a} مطلب';
$string['completiondetail:replies'] = 'پاسخ به {$a} مطلب';
$string['completiondiscussions'] = 'شاگرد باید این تعداد گفتگو را شروع کرده باشد:';
$string['completiondiscussionsdesc'] = 'شاگرد باید حداقل {$a} گفتگو ایجاد کند';
$string['completiondiscussionsgroup'] = 'نیازمند شروع گفتگو';
$string['completiondiscussionshelp'] = 'برای کامل در نظر گرفته شدن باید مباحثه‌هایی شروع شود';
$string['completionposts'] = 'شاگرد باید این تعداد گفتگوی جدید را شروع کند یا در گفتگوهای موجود مطلب بیان کند:';
$string['completionpostsdesc'] = 'شاگرد باید حداقل {$a} پست در گفتگو/ها یا پاسخ به آنها ارسال کند';
...
$string['completionreplies'] = 'شاگرد باید به این تعداد در پاسخ به مطالب موجود در گفتگوها مطلب بیان کند:';
$string['completionrepliesdesc'] = 'شاگرد باید حداقل {$a} پاسخ ارسال کند';
$string['completionrepliesgroup'] = 'نیازمند مشارکت در گفتگو';
...
$string['configdisplaymode'] = 'نحوهٔ نمایش گفتگوها به صورت پیش‌فرض';
...
$string['configenabletimedposts'] = 'با انتخاب این گزینه، می‌توان هنگام طرح گفتگوهای جدید محدوده‌ای برای نمایش تعیین کرد.';
...
$string['cutoffdatereached'] = 'مهلت برای ارسال مطلبی در این تالارگفتگو به پایان رسیده است، بنابراین دیگر نمی‌توانید در آن مطلبی ارسال کنید.';
$string['cutoffdatevalidation'] = 'تاریخ عدم پذیرش نمی‌تواند قبل از مهلت تحویل باشد.';
$string['delete'] = 'حذف';
$string['deleteddiscussion'] = 'این گفتگو حذف شده است';
...
$string['digestmailpost'] = 'تنظیمات دریافت خلاصهٔ تالارگفتگو را برای خود تغییر دهید';
$string['digestmailpostlink'] = 'تنظیمات دریافت خلاصهٔ تالارگفتگو را برای خود تغییر دهید: {$a}';
...
$string['disallowsubscription_help'] = 'پیکربندی این تالار به‌گونه‌ای است که نمی‌توانید در گفتگوها آبونه شوید.';
$string['discussion'] = 'گفتگو';
$string['discussionlocked'] = 'این گفتگو قفل شده است و در نتیجه دیگر نمی‌توانید در آن شرکت کنید.';
$string['discussionlockingdisabled'] = 'گفتگوها قفل نشوند';
$string['discussionlockingheader'] = 'قفل‌کردن گفتگوها';
$string['discussionmoved'] = 'این گفتگو به «{$a}» منتقل شد.';
$string['discussionmovedpost'] = 'این گفتگو به <a href="{$a->discusshref}">این محل</a> واقع در تالار «<a href="{$a->forumhref}">{$a->forumname}</a>» منتقل شد';
$string['discussionname'] = 'نام گفتگو';
...
$string['discussions'] = 'گفتگوها';
$string['discussionsstartedby'] = 'گفتگوهایی که توسط {$a} آغاز شده‌اند';
$string['discussionsstartedbyrecent'] = 'گفتگوهایی که اخیراً توسط {$a} آغاز شده‌اند';
$string['discussionsstartedbyuserincourse'] = 'گفتگوهای شروع شده توسط {$a->fullname} در {$a->coursename}';
$string['discussionstartedby'] = 'گفتگوی آغاز شده با {$a}';
$string['discussionsubscribestart'] = 'من را از مطالب جدید در این گفتگو باخبر کن';
$string['discussionsubscribestop'] = 'نمی‌خواهم از مطالب جدید این گفتگو باخبر شوم';
$string['discussionsubscription'] = 'آبونه‌شدن در این گفتگو';
$string['discussionsubscription_help'] = 'با آبونه‌شدن در یک گفتگو از مطالب جدیدی که در مباحثه مطرح می‌شوند آگاه خواهید شد.';
...
$string['emaildigestoffshort'] = 'عدم دریافت خلاصه مطالب';
$string['emaildigestsubjectsshort'] = 'فقط موضوع‌ها';
$string['emaildigesttype'] = 'گزینه‌های ایمیل برای دریافت خلاصه مطالب';
...
$string['everyonecanchoose'] = 'هر کس که بخواهد می‌تواند مشترکگفتگوهای این تالار شود';
$string['everyonecannowchoose'] = 'هر کس که بخواهد می‌تواند مشترک گفتگوهای این تالار شود';
$string['everyoneisnowsubscribed'] = 'همه مشترک گفتگوهای این تالار شدند';
...
$string['exportoptions'] = 'گزینه‌های صدور';
...
$string['forum:exportforum'] = 'صدور تالار گفتگو';
$string['forum:exportownpost'] = 'صدور مطلب خود';
$string['forum:exportpost'] = 'صدور مطلب';
...
$string['forum:postprivatereply'] = 'پاسخ خصوصی به پست‌ها';
...
$string['forum:viewdiscussion'] = 'مشاهدهٔ گفتگوها';
...
$string['forumgradingpanel'] = 'پنل نمره‌دهی تالارگفتگو';
$string['forumintro'] = 'توصیف';
$string['forumname'] = 'نام تالار';
$string['forumposts'] = 'مطالب بیان شده در تالارهای گفتگو';
...
$string['grade_forum_header'] = 'نمره‌دهی کل تالار گفتگو';
$string['grade_forum_name'] = 'کل تالار گفتگو';
$string['grade_forum_title'] = 'نمره';
$string['graded'] = 'نمره داده شده';
$string['gradedby'] = 'نمره داده شده توسط';
$string['gradeitemnameforrating'] = 'نمره‌دهی برای {$a->name}';
$string['gradeitemnameforwholeforum'] = 'نمره‌دهی کل تالار گفتگو برای {$a->name}';
$string['gradeusers'] = 'نمره‌دهی کاربران';
$string['grading'] = 'نمره‌دهی';
$string['gradingstatus'] = 'وضعیت نمره:';
$string['hidegraderpanel'] = 'پنهان کردن پنل نمره‌دهنده';
$string['indexoutoftotal'] = '{$a->index} از {$a->total}';
...
$string['introteacher'] = 'تالاری برای طرح گفتگوها و ملاحظات مختص اساتید';
...
$string['lockdiscussion'] = 'قفل کردن این گفتگو';
$string['lockdiscussionafter'] = 'قفل‌کردن گفتگوها بعد از مدتی غیرفعال بودن';
$string['lockdiscussionafter_help'] = 'گفتگوها می‌توانند پس از گذشت زمان تعیین‌شده از زمان ارسال آخرین مطلب به‌طور خودکار قفل شوند.

کاربرانی که مجوز پاسخ‌دادن به گفتگوهای قفل‌شده را دارند می‌توانند با پاسخ‌دادن به گفتگو، آن را از حالت قفل‌شده خارج کنند.';
...
$string['managesubscriptionsoff'] = 'پایان مدیریت اشتراک‌ها';
$string['managesubscriptionson'] = 'مدیریت اشتراک‌ها';
$string['manydiscussions'] = 'تعداد گفتگوها در هر صفحه';
...
$string['markasread'] = 'علامت بزن به عنوان خوانده شده';
$string['markasreadonnotification'] = 'وقتی اطلاعیه ارسال یک پست می‌آید';
$string['markasreadonnotification_help'] = 'وقتی شما از یک مطاب در تالار گفتگو با خبر می‌شوید، به جهت دنبال کردن مطالب، می‌توانید مشخص کنید که آن مطلب به عنوان خوانده شده، علامت بخورد یا خیر.';
$string['markasreadonnotificationno'] = 'مطلب به عنوان خوانده شده علامت زده نشود';
$string['markasreadonnotificationyes'] = 'مطلب به عنوان خوانده شده علامت گذاری شود';
...
$string['movethisdiscussionto'] = 'انتقال کل گفتگو به ...';
$string['mustprovidediscussionorpost'] = 'برای انجام صدور، باید شناسهٔ مباحثه یا شناسهٔ مطلب فراهم شده باشد';
$string['myprofileotherdis'] = 'گفتگوهای شروع‌شده در تالارها';
$string['myprofileownpost'] = 'مطالب بیان شدهٔ من در تالار گفتگو';
...
$string['newforumposts'] = 'مطالب جدید تالار گفتگو';
...
$string['noguestsubscribe'] = 'متأسفانه مهمانان اجازهٔ مشترک شدن و دریافت مطالب تالارها از طریق پست الکترونیک را ندارند.';
...
$string['noviewdiscussionspermission'] = 'شما مجوز مشاهدهٔ گفتگو‌های این تالار را ندارید';
...
$string['olderdiscussions'] = 'گفتگوهای قدیمی‌تر';
...
$string['pindiscussion'] = 'سنجاق کردن این گفتگو';
...
$string['postisprivatereply'] = 'این یک پاسخ خصوصی است. برای سایر شرکت کنندگان قابل مشاهده نیست.';
$string['postmailinfo'] = 'این یک نسخه از مطلبی است که به وب‌گاه {$a} ارسال شده است.

جهت اضافه کردن مطلب خود از طریق وب‌گاه، بر روی این پیوند کلیک کنید:';
...
$string['privacy:metadata:forum_digests:maildigest'] = 'ترجیحات دریافت خلاصه';
$string['privatereply'] = 'پاسخ خصوصی';
$string['processingdigest'] = 'شروع ارسال پست الکترونیک خلاصه به {$a}';
$string['processingpost'] = 'پردازش مطلب {$a}';
$string['prune'] = 'انشقاق';
$string['prunedpost'] = 'یک گفتگوی جدید از آن مطلب ایجاد شده است';
$string['pruneheading'] = 'انشقاق گفتگو و انتقال این مطلب به یک گفتگوی جدید';
...
$string['removefromfavourites'] = 'برداشتن ستاره از این گفتگو';
...
$string['replyplaceholder'] = 'پاسخ خود را بنویسید...';
...
$string['rssarticles_help'] = 'این گزینه تعداد مواردی (تعداد گفتگوها یا تعداد مطالب) که در RSS feed می‌آیند را تعیین می‌کند. معمولاً مقادیر بین ۵ و ۲۰ قابل قبول هستند.';
...
$string['rsstype_help'] = 'برای فعال کردن RSS feed برای این فعالیت، یکی از گزینه‌های گفتگوها یا مطالب را برای شامل شدن در feed انتخاب کنید.';
$string['search'] = 'جستجو';
...
$string['sendstudentnotificationsno'] = 'خیر';
$string['sendstudentnotificationsyes'] = 'بله، به شاگردان اطلاع بده';
$string['settings'] = 'تنظیمات';
$string['shortpost'] = 'مطلب کوتاه';
$string['showgraderpanel'] = 'نمایش پنل نمره‌دهنده';
$string['showmoreusers'] = 'نمایش بیشتر کاربران';
...
$string['starredonly'] = 'جستجو فقط در میان گفتگوهای ستاره‌دار';
$string['startedby'] = 'شروع‌کنندهٔ گفتگو';
...
$string['subscribediscussion'] = 'آبونه شدن در این گفتگو';
...
$string['tagarea_forum_posts'] = 'مطالب بیان شده در تالار گفتگو';
...
$string['togglefullscreen'] = 'تعویض به حالت تمام‌صفحه';
$string['togglesettingsdrawer'] = 'باز و بسته کردن کشوی تنظیمات';
...
$string['unlockdiscussion'] = 'باز کردن این گفتگو';
$string['unpindiscussion'] = 'برداشتن سنجاق از این گفتگو';
...
$string['unsubscribediscussion'] = 'لغو اشتراک در این گفتگو';
$string['unsubscribeshort'] = 'لغو اشتراک';
$string['useexperimentalui'] = 'استفاده از نمای گفتگوی تو در تو';
$string['usermarksread'] = 'علامت‌گذاری خواندن مطالب به صورت دستی';
$string['usersforumposts'] = 'مطالب بیان شدهٔ کاربر در تالار گفتگو';
$string['viewalldiscussions'] = 'مشاهدهٔ همهٔ گفتگوها';
$string['viewconversation'] = 'مشاهدهٔ گفتگو';
$string['viewgrades'] = 'دیدن نمره‌ها';
$string['viewthediscussion'] = 'مشاهدهٔ گفتگو';
...
$string['yournewtopic'] = 'گفتگوی جدید شما';
