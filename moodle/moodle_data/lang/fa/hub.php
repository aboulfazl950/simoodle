...
/**
 * Strings for component 'hub', language 'fa', version '4.5'.
 *
 * @package     hub
 * @category    string
...
$string['policyagreed'] = 'اعلامیه حفظ حریم خصوصی و توافقنامه پردازش داده ها';
$string['policyagreeddesc'] = 'من با <a href="{$a}" target="_blank">اطلاعیه حریم خصوصی و قرارداد پردازش داده</a> موافقم';
...
$string['registerwithmoodleorginfo'] = 'ثبت سایت شما شامل ارسال دوره‌ای <a href="{$a->moreinformation}" class="focus-expand">آمارهای سایت به صورت ناشناس</a> به HQ Moodle است. این به ما کمک می‌کند تا در مورد نحوه استفاده شما از Moodle اطلاعاتی کسب کنیم و در مورد ویژگی‌ها و افزونه‌های جدید تصمیم گیری کنیم.

به‌علاوه، به شما امکان می‌دهد:

* از به‌روزرسانی‌های مهم، مانند هشدارهای امنیتی و نسخه‌های جدید موجود، مطلع شده و به‌روز باشید.
* اعلان‌های ارسال برای تلفن همراه را برای <a href="{$a->moodleapp}">برنامه موبایل مودل</a> فعال کنید.
* مشاهده سایت خود را با قرار دادن آن در لیست سایت‌های Moodle ثبت شده در کشور خود افزایش دهید (اختیاری).';
...
$string['sitecommnews'] = 'خبرنامه مودل';
$string['sitecommnews_help'] = 'شما این امکان را دارید که در خبرنامه مودل ما مشترک شوید. می توانید در هر زمانی اشتراک خود را لغو کنید.';
$string['sitecommnewsyes'] = 'بله، من می خواهم خبرنامه مودل را دریافت کنم';
...
$string['siteorganisationtype'] = 'نوع سازمان';
$string['siteorganisationtype_help'] = 'ارائه نوع سازمان شما به ما کمک می کند تا انواع سازمان‌هایی که از Moodle استفاده می‌کنند و نیازهای آنها را بهتر بشناسیم.';
