...
/**
 * Strings for component 'assignsubmission_onlinetext', language 'fa', version '4.5'.
 *
...
$string['eventassessableuploaded'] = 'یک متن بر خط بارگذاری شده است.';
$string['numwords'] = '({$a} کلمه)';
$string['onlinetext'] = 'متن برخط';
$string['onlinetextsubmission'] = 'مجاز بودن تحویل از نوع متن برخط';
