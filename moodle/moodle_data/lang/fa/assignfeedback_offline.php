...
/**
 * Strings for component 'assignfeedback_offline', language 'fa', version '4.5'.
 *
...
$string['enabled'] = 'کاربرگ نمره‌دهی آفلاین';
...
$string['offlinegradingworksheet'] = 'نمره‌ها';
$string['pluginname'] = 'کاربرگ نمره‌دهی آفلاین';
