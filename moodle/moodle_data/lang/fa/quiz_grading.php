...
/**
 * Strings for component 'quiz_grading', language 'fa', version '4.5'.
 *
...
$string['gradingattemptwithcustomfields'] = 'دفعهٔ {$a->attempt} ام از تلاش‌های {$a->fullname} ({$a->customfields})';
