...
/**
 * Strings for component 'tool_mobile', language 'fa', version '4.5'.
 *
 * @package     tool_mobile
 * @category    string
...
$string['managefiletypes'] = 'مدیریت انواع فایل';
...
$string['mobileappsubscription'] = 'اشتراک برنامه مودل موبایل';
$string['mobileauthentication'] = 'شناسایی موبایل';
$string['mobilecssurl'] = 'CSS';
$string['mobilefeatures'] = 'امکانات موبایل';
...
$string['qrcodeformobileappaccess'] = 'کد کیوآر برای دسترسی اپ موبایل';
$string['qrcodeformobileapploginabout'] = 'با استفاده از اپ موبایلتان، کد کیوآر را اسکن کنید تا به‌طور خودکار لاگین شوید. کد کیوآر ظرف {$a} دقیقه منقضی خواهد شد.';
$string['qrcodeformobileappurlabout'] = 'با استفاده از اپ موبایلتان، کد کیوآر را اسکن کنید تا آدرس سایت در اپ شما وارد شود.';
...
$string['viewqrcode'] = 'نمایش کد کیوآر';
