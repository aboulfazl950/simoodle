...
/**
 * Strings for component 'role', language 'fa', version '4.5'.
 *
 * @package     role
 * @category    string
...
$string['confirmaddadmin'] = 'آیا واقعاً می‌خواهید کاربر <strong>{$a}</strong> را به عنوان یک مدیر سایت جدید اضافه کنید؟';
