...
/**
 * Strings for component 'gradereport_singleview', language 'fa', version '4.5'.
 *
...
$string['gotonextreport'] = 'برو به گزارش کاربر بعدی';
$string['gotopreviousreport'] = 'برو به گزارش کاربر قبلی';
...
$string['selectagrade'] = 'یک مورد نمره را انتخاب کنید';
$string['selectgradeitemlink'] = 'یک مورد نمره را انتخاب کنید';
$string['singleviewdescription'] = 'در نمای تکی می‌توانید نمره‌های انتخابی را لغو یا حذف کنید و نمره‌ها را به صورت انبوه درج کنید.';
$string['singleviewreport_gradeitem'] = 'نمای تکی برای این مورد';
$string['viewby'] = 'مشاهده بر اساس';
$string['viewsinglegradeitem'] = 'یک مورد نمره را از بالا انتخاب کنید';
$string['viewsingleuser'] = 'جستجوی یک کاربر برای مشاهده همه نمر‌ه‌هایش';
