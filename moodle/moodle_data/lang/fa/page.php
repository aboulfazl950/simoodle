...
/**
 * Strings for component 'page', language 'fa', version '4.5'.
 *
 * @package     page
 * @category    string
...
$string['printlastmodified'] = 'نمایش تاریخ آخرین تغییرات';
$string['printlastmodifiedexplain'] = 'آیا تاریخ آخرین تغییرات زیر محتوا نمایش داده شود؟';
