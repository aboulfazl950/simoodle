...
/**
 * Strings for component 'block_myoverview', language 'fa', version '4.5'.
 *
...
$string['sortbylastaccessed'] = 'مرتب سازی بر اساس آخرین دسترسی‌';
$string['sortbyshortname'] = 'مرتب سازی بر اساس نام کوتاه';
$string['sortbytitle'] = 'مرتب سازی بر اساس نام درس';
$string['summary'] = 'خلاصه';
$string['title'] = 'نام درس';
$string['zero_default_intro'] = 'به محض اینکه شما در یک درس ثبت‌نام شوید، اینجا ظاهر خواهد شد.';
$string['zero_default_title'] = 'شما در هیچ درسی ثبت‌نام نیستید';
