...
/**
 * Strings for component 'auth_oauth2', language 'fa', version '4.5'.
 *
 * @package     auth_oauth2
 * @category    string
...
$string['accountexists'] = 'یک حساب کاربری با همین نام کاربری در این سایت وجود دارد. اگر این حساب کاربری شماست، با وارد کردن نام کاربری و رمز عبور خود وارد شوید و از طریق صفحهٔ ترجیحات خود، آن را به عنوان یک حساب کاربری مرتبط اضافه کنید.';
...
اگر شما این درخواست را ارسال نکرده‌اید، شخص دیگری ممکن است سعی در دسترسی به حساب کاربری شما داشته باشد.
لطفاً به سرعت با مدیر سایت تماس بگیرید.';
...
$string['loginerror_cannotcreateaccounts'] = 'حساب کاربری‌ای با آدرس ایمیل شما پیدا نشد.';
