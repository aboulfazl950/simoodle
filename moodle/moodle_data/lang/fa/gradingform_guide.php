...
/**
 * Strings for component 'gradingform_guide', language 'fa', version '4.5'.
 *
...
$string['alwaysshowdefinition'] = 'نمایش تعاریف راهنما به شاگردان';
...
$string['confirmdeletecriterion'] = 'آیا مطمئن هستید که می‌خواهید این مورد را حذف کنید؟';
$string['confirmdeletelevel'] = 'آیا مطمئن هستید که می‌خواهید این سطح را حذف کنید؟';
...
$string['criterionremark'] = 'ملاحظات معیار {$a}';
