...
/**
 * Strings for component 'grading', language 'fa', version '4.5'.
 *
 * @package     grading
 * @category    string
...
$string['searchownforms'] = 'شامل فرم‌های خودم بشود';
$string['searchtemplate'] = 'جستجوی فرم‌های نمره‌دهی';
$string['statusdraft'] = 'پیش‌نویس';
$string['statusready'] = 'آماده استفاده';
$string['templateedit'] = 'ویرایش';
$string['templatepickconfirm'] = 'آیا مایلید از فرم نمره‌دهی  \'{$a->formname}\' به عنوان یک قالب برای نمره‌دهی جدید در \'{$a->component} ({$a->area})\' استفاده کنید؟';
$string['templatesource'] = 'مکان: {$a->component} ({$a->area})';
