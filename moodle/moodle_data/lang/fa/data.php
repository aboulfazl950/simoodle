...
/**
 * Strings for component 'data', language 'fa', version '4.5'.
 *
 * @package     data
 * @category    string
...
$string['approvalstatus'] = 'وضعیت تایید';
$string['approve'] = 'تایید';
$string['approved'] = 'تایید شده';
$string['areacontent'] = 'فیلد‌ها';
...
$string['availabletodatevalidation'] = 'تاریخ پایان دسترسی نمی‌تواند قبل از تاریخ آغاز دسترسی باشد';
...
$string['cannotoverwritepreset'] = 'خطا در بازنویسی مجموعه‌های آماده';
$string['cannotunziptopreset'] = 'نمی‌توان فایل مجموعهٔ آماده را از حالت فشرده خارج کرد';
$string['checkbox'] = 'گزینهٔ علامت‌زدنی';
...
$string['closebeforeopen'] = 'شما تاریخ پایان را قبل از تاریخ شروع مشخص کرده‌اید';
$string['columns'] = 'ستون';
$string['comment'] = 'نظر';
...
$string['completionentries'] = 'نیاز به ورودی‌ها';
$string['completionentriescount'] = 'شمارش ورودی‌ها';
$string['completionentriesdesc'] = 'حداقل تعداد ورودی‌های مورد نیاز: {$a}';
...
$string['confirmdeleterecords'] = 'آیا از حذف این مقادیر ورودی مطمئن هستید؟';
...
$string['csvwithselecteddelimiter'] = 'فایل متنی <abbr title="Comma Separated Values (مقادیر جدا شده از هم توسط کاما)">CSV</abbr> با حرفِ جداکنندهٔ انتخاب شده:';
...
$string['data:exportuserinfo'] = 'صدور اطلاعات کاربر';
...
$string['data:view'] = 'مشاهده فعالیت بانک اطلاعاتی';
...
$string['delcheck'] = 'کادر انتخابی برای حذف انبوه';
$string['delete'] = 'حذف';
...
$string['enabletemplateeditorcheck'] = 'آیا مطمئن هستید که می‌خواهید ویرایشگر را فعال کنید؟ این ممکن است منجر به تغییر محتوا در هنگام ذخیره الگو شود.';
...
$string['errormustsupplyvalue'] = 'باید این قسمت را پر کنید.';
$string['errorpresetexists'] = 'یک مجموعهٔ آماده با همین نام از قبل وجود دارد';
$string['eventfieldcreated'] = 'فیلد ایجاد شد';
$string['eventfielddeleted'] = 'فیلد حذف شد';
$string['eventfieldupdated'] = 'فیلد به روز شد';
$string['eventrecordcreated'] = 'رکورد ذخیره شد';
$string['eventrecorddeleted'] = 'رکورد حذف شد';
$string['eventrecordupdated'] = 'رکورد به روز شد';
$string['eventtemplateupdated'] = 'قالب به روز شد';
$string['eventtemplateviewed'] = 'قالب‌ها مشاهده شدند';
...
$string['exportformat'] = 'صدور قالب';
$string['exportoptions'] = 'صدور قالب‌ها';
$string['exportownentries'] = 'فقط صادر شدن داده‌های وارد شدهٔ خودتان؟ ({$a->mine} از {$a->all})';
$string['exportpreset'] = 'صدور ازمجموعه‌های آماده';
...
$string['headeraddtemplate'] = 'طراحی ظاهر صفحهٔ ویرایش و اضافه کردن ورودی‌ها';
$string['headerasearchtemplate'] = 'طراحی ظاهر فرم جستجوی پیشرفته';
$string['headercsstemplate'] = 'تعریف CSS های داخلی برای سایر قالب‌ها';
$string['headerjstemplate'] = 'تعریف جاوا اسکریپت‌های سفارشی برای دست‌کاری نحوه نمایش المان‌ها در لیست یا به صورت تکی یا در قالب‌ها';
...
$string['importpreset'] = 'وارد کردن یک مجموعه آماده';
$string['importsuccess'] = 'مجموعهٔ آماده با موفقیت استفاده شد.';
$string['includeapproval'] = 'شامل وضعیت تایید';
$string['includetags'] = 'شامل تگ‌ها';
$string['includetime'] = 'شامل تاریخ ورود/تغییر';
$string['includeuserdetails'] = 'شامل جزییات کاربر';
$string['indicator:cognitivedepth'] = 'بانک اطلاعاتی شناختی';
$string['indicator:cognitivedepth_help'] = 'این شاخص بر اساس عمق شناختی شاگرد در یک فعالیت بانک اطلاعاتی است.';
$string['indicator:cognitivedepthdef'] = 'بانک اطلاعاتی شناختی';
$string['indicator:cognitivedepthdef_help'] = 'شرکت‌کننده به این درصد از درگیری شناختی ارائه‌شده توسط فعالیت‌های بانک اطلاعاتی در این بازه زمانی تحلیل رسیده است (سطوح = بدون مشاهده، مشاهده، ارسال)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'بانک اطلاعاتی اجتماعی';
$string['indicator:socialbreadth_help'] = 'این شاخص بر اساس وسعت اجتماعی شاگرد در یک فعالیت بانک اطلاعاتی است.';
$string['indicator:socialbreadthdef'] = 'بانک اطلاعاتی اجتماعی';
$string['indicator:socialbreadthdef_help'] = 'شرکت‌کننده به این درصد از مشارکت اجتماعی ارائه‌شده توسط فعالیت‌های بانک اطلاعاتی در این بازه زمانی تحلیل رسیده است (سطوح = بدون مشارکت، شرکت‌کننده به تنهایی)';
...
$string['latlongboth'] = 'هم طول و هم عرض جغرافیایی لازم است.';
...
$string['managefields'] = 'مدیریت فیلدها';
...
$string['newfield_help'] = 'از طریق فیلدها می‌توان داده‌ها را وارد کرد. هر دادهٔ ورودی در یک فعالیت بانک اطلاعاتی می‌تواند شامل چندین فیلد از انواع مختلف باشد. مانند فیلدهای تاریخی که به افراد امکان انتخاب یک روز، ماه و سال را از یک لیست بازشونده می‌دهند؛ فیلدهای تصویری که به افراد اجازهٔ ارسال یک فایل تصویری را می‌دهند؛ یا گزینه‌های علامت‌زدنی که به افراد اجازهٔ انتخاب یک یا چند گزینه را می‌دهند.
...
$string['ods'] = 'فایل <abbr title="OpenDocument Spreadsheet (برنامهٔ صفحه گسترده در مجموعهٔ اپن آفیس)">ODS</abbr> (مجموعهٔ OpenOffice)';
$string['openafterclose'] = 'شما یک تاریخ بازشدن را بعد از تاریخ بسته شدن مشخص کرده‌اید';
...
$string['presetnotselected'] = 'هیچ مجموعه آماده‌ای انتخاب نشده است.';
$string['presets'] = 'مجموعه‌های آماده';
$string['privacy:metadata:commentpurpose'] = 'نظرات در رکورد‌های بانک اطلاعاتی';
$string['privacy:metadata:data_content'] = 'یک پاسخ به یک فیلد در ماژول فعالیت بانک اطلاعاتی را نشان می‌دهد';
$string['privacy:metadata:data_content:content'] = 'محتوا';
$string['privacy:metadata:data_content:content1'] = 'محتوای اضافی ۱';
$string['privacy:metadata:data_content:content2'] = 'محتوای اضافی ۲';
$string['privacy:metadata:data_content:content3'] = 'محتوای اضافی ۳';
$string['privacy:metadata:data_content:content4'] = 'محتوای اضافی ۴';
$string['privacy:metadata:data_content:fieldid'] = 'شناسه تعریف فیلد';
$string['privacy:metadata:data_records'] = 'نمایش رکوردها در ماژول فعالیت بانک اطلاعاتی';
$string['privacy:metadata:data_records:approved'] = 'وضعیت تایید';
$string['privacy:metadata:data_records:groupid'] = 'گروه';
$string['privacy:metadata:data_records:timecreated'] = 'زمانی که رکورد ایجاد شده بود';
$string['privacy:metadata:data_records:timemodified'] = 'زمان آخرین باری که رکورد  تغییر یافته بود';
$string['privacy:metadata:data_records:userid'] = 'کاربری که رکورد را ایجاد کرده است';
$string['privacy:metadata:datafieldnpluginsummary'] = 'فیلد‌های ماژول فعالیت بانک اطلاعاتی';
$string['privacy:metadata:filepurpose'] = 'فایل به رکورد بانک اطلاعاتی پیوست شد';
$string['privacy:metadata:ratingpurpose'] = 'امتیازدهی روی رکوردهای بانک اطلاعاتی';
$string['privacy:metadata:tagpurpose'] = 'تگ‌های روی رکوردهای بانک اطلاعاتی';
$string['radiobutton'] = 'دکمه‌های رادیویی';
$string['recordapproved'] = 'دادهٔ ورودی تایید شد';
$string['recorddeleted'] = 'حذف شد';
$string['recorddisapproved'] = 'ورودی تایید نشده';
$string['recordsnotsaved'] = 'هیچ داده‌ای ذخیره نشد. لطفاً قالب فایل ارسال شده را بررسی کنید.';
$string['recordssaved'] = 'داده ذخیره شد';
$string['removealldatatags'] = 'حذف همه تگ‌های بانک اطلاعاتی';
...
$string['requiredentrieswarning'] = 'این تنظیم با تنظیم تکمیل فعالیت «نیاز به ورودی‌ها» جایگزین شده است.';
...
$string['saveaspresetmissingcapability'] = 'کاربر مجوز ذخیره بانک اطلاعاتی به عنوان یک مجموعه آماده را ندارد';
$string['savedataaspreset'] = 'ذخیره همه فیلدها و قالب‌ها به عنوان مجموعه آماده از پیش تعیین شده';
...
$string['tagarea_data_records'] = 'داده‌های رکوردها';
$string['tags'] = 'tag ها';
$string['tagsdeleted'] = 'تگ‌های بانک اطلاعاتی حذف شدند';
...
$string['unsupportedfields'] = 'فیلد‌های پشتیبانی نشده';
$string['unsupportedfieldslist'] = 'این فیلدها نمی‌توانند صادر بشوند:';
...
$string['usedate'] = 'شامل جستجو بشود.';
$string['usepredefinedset'] = 'استفاده از مجموعه از پیش تعریف شده';
$string['usepreset'] = 'استفاده از مجموعه آماده';
...
$string['viewtodatevalidation'] = 'زمان فقط خواندنی بودن داده‌ها «تا تاریخ...» نمی تواند قبل از «از تاریخ...» باشد.';
