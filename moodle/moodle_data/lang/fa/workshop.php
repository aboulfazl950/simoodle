...
/**
 * Strings for component 'workshop', language 'fa', version '4.5'.
 *
 * @package     workshop
 * @category    string
...
$string['activitydate:assessmentsclose'] = 'ارزیابی‌ها بسته می‌شود:';
$string['activitydate:assessmentsclosed'] = 'ارزیابی‌ها بسته شد در:';
$string['activitydate:assessmentsopen'] = 'بازشدن ارزیابی در:';
$string['activitydate:assessmentsopened'] = 'ارزیابی باز شده در:';
$string['activitydate:submissionsclose'] = 'بسته شدن تحویل در:';
$string['activitydate:submissionsclosed'] = 'امکان تحویل‌ها بسته شد در:';
$string['activitydate:submissionsopen'] = 'باز شدن زمان تحویل‌ها در:';
$string['activitydate:submissionsopened'] = 'باز شدن زمان تحویل‌ها در:';
$string['aggregategrades'] = 'محاسبهٔ مجدد نمره‌ها';
$string['aggregation'] = 'اجتماع نمره‌ها';
$string['allocate'] = 'اختصاص برای بازبینی';
$string['allocatedetails'] = 'مورد انتظار: {$a->expected}<br />تحویل داده شده: {$a->submitted}<br />در انتظار اختصاص: {$a->allocate}';
$string['allocation'] = 'تخصیص برای بازبینی';
$string['allocationconfigured'] = 'امکان تخصیص تنظیم شد';
$string['allocationdone'] = 'تخصیص انجام شد';
$string['allocationerror'] = 'تخصیص با خطا مواجه شد';
$string['allowedfiletypesforoverallfeedback'] = 'نوع فایل‌های قابل قبول برای بازخورد';
...
$string['allsubmissions'] = 'تمام کارهای تحویل داده شده ({$a})';
$string['alreadygraded'] = 'نمره داده شده است';
$string['areaconclusion'] = 'متن نتیجه‌گیری';
$string['areainstructauthors'] = 'دستورالعمل چگونگی تحویل دادن';
$string['areainstructreviewers'] = 'دستورالعمل چگونگی ارزشیابی';
$string['areaoverallfeedbackattachment'] = 'ضمیمه‌های بازخورد عمومی';
$string['areaoverallfeedbackcontent'] = 'متن‌های بازخورد عمومی';
...
$string['assessmentend'] = 'مهلت نهایی برای ارزشیابی';
$string['assessmentenddatetime'] = 'مهلت ارزشیابی: {$a->daydatetime} ({$a->distanceday})';
$string['assessmentendevent'] = '{$a} مهلت برای ارزشیابی';
...
$string['assessmentstartevent'] = '{$a} برای ارزشیابی باز می‌شود';
...
$string['byfullnamewithoutlink'] = 'توسط {$a}';
...
$string['calculatesubmissiongrades'] = 'محاسبهٔ نمرهٔ کارهای تحویل داده شده';
...
$string['clearaggregatedgrades_help'] = 'نمره‌های جمع شده برای کارهای تحویل داده شده و نمره‌های ارزشیابی‌ها پاک خواهند شد. این نمره‌ها را مجددا در مرحله نمره‌دهی می‌توانید از نو محاسبه کنید.';
...
$string['createsubmission'] = 'اضافه کردن تحویل';
...
$string['deadlinesignored'] = 'محدودیت‌های زمانی برای شما اِعمال نمی‌شود';
$string['deletesubmission'] = 'حذف کار تحویل داده شده';
...
$string['editsubmission'] = 'ویرایش کار تحویل داده شده';
...
$string['evaluationsettings'] = 'تنظیمات ارزشیابی برای نمره‌دهی';
$string['eventassessableuploaded'] = 'یک کار تحویل و بارگذاری شد.';
$string['eventassessmentevaluated'] = 'ارزشیابی بررسی شد';
$string['eventassessmentevaluationsreset'] = 'بازنشانی بررسی‌‌های مربوط به ارزشیابی کار';
$string['eventassessmentreevaluated'] = 'ارزشیابی‌ دوباره بررسی شد';
$string['eventphaseautomaticallyswitched'] = 'به طور خودکار تعویض مرحله انجام شد';
$string['eventphaseswitched'] = 'تعویض مرحله انجام شد';
$string['eventsubmissionassessed'] = 'تحویل کار ارزیابی شد';
$string['eventsubmissionassessmentsreset'] = 'ارزشیابی‌های کار تحویل داده شده پاک شد';
$string['eventsubmissioncreated'] = 'تحویل کار ایجاد شد';
$string['eventsubmissiondeleted'] = 'تحویل کار حذف شد';
$string['eventsubmissionreassessed'] = 'تحویل کار دوباره ارزیابی شد';
$string['eventsubmissionupdated'] = 'تحویل کار به روز شد';
$string['eventsubmissionviewed'] = 'تحویل کار مشاهده شد';
...
$string['exportsubmission'] = 'صدور این صفحه';
$string['feedbackauthor'] = 'بازخورد برای ارائه دهنده';
$string['feedbackauthorattachment'] = 'ضمیمه';
...
$string['grade_grading_name'] = 'ارزیابی کار';
$string['grade_submission_name'] = 'تحویل کار';
...
$string['latesubmissions_help'] = 'در صورتی که فعال باشد، کاربران می‌توانند پس از مهلت تحویل یا در طول مرحله ارزشیابی، کارشان را تحویل دهند. البته، کارهایی که دیر تحویل داده شده باشند قابل ویرایش نیستند.';
...
$string['myassessments'] = 'ارزشیابی‌های من';
...
$string['nullgrade'] = '–';
$string['overallfeedback'] = 'بازخورد عمومی';
$string['overallfeedbackfiles'] = 'حداکثر تعداد ضمیمه‌های بازخورد عمومی';
$string['overallfeedbackmaxbytes'] = 'حداکثر اندازه فایل بازخورد عمومی';
$string['overallfeedbackmode'] = 'حالت بازخورد عمومی';
$string['overallfeedbackmode_0'] = 'غیرفعال';
$string['overallfeedbackmode_1'] = 'فعال و اختیاری';
$string['overallfeedbackmode_2'] = 'فعال و الزامی';
...
$string['phaseassessment'] = 'مرحله ارزشیابی';
$string['phaseclosed'] = 'بسته';
$string['phaseevaluation'] = 'مرحله نمره‌دهی';
$string['phasesetup'] = 'مرحله راه‌اندازی';
$string['phasesoverlap'] = 'مرحله ارزشیابی و مرحله تحویل نمی‌توانند همپوشانی داشته باشند';
$string['phasesubmission'] = 'مرحله تحویل';
...
$string['resetassessments'] = 'حذف همه ارزشیابی‌ها';
$string['resetphase'] = 'تعویض به مرحله راه‌اندازی';
$string['resetphase_help'] = 'اگر فعال شود، همه کارگاه‌ها در مرحله راه اندازی اولیه قرار می‌گیرند';
...
$string['saveandshownext'] = 'ذخیره و نمایش بعدی';
...
$string['showingperpagechange'] = 'تغییر ...';
...
$string['submissionendswitch'] = 'تعویض به مرحله بعدی بعد از پایان مهلت تحویل';
...
$string['submissionsallocation'] = 'تخصیص مطالب تحویل داده شده';
$string['submissionsettings'] = 'تنظیمات مربوط به تحویل کار';
$string['submissionsreport'] = 'گزارش موارد تحویل داده شده در کارگاه';
...
$string['submissiontypedisabled'] = 'این نوع تحویل کار برای این کارگاه غیرفعال است';
$string['submissiontypefileavailable'] = 'ضمیمه کردن فایل <span class="accesshide"> در دسترس</span>';
$string['submissiontypefilerequired'] = '<span class="accesshide">ضمیمه کردن فایل </span>لازم است';
$string['submissiontypes'] = 'روش‌های تحویل';
$string['submissiontypetextavailable'] = 'متن برخط <span class="accesshide"> در دسترس</span>';
$string['submissiontypetextrequired'] = '<span class="accesshide">متن برخط</span>لازم است';
$string['submittednotsubmitted'] = 'تحویل داده شده ({$a->submitted}) / منتظر تحویل ({$a->notsubmitted})';
$string['switchingphase'] = 'تغییر فاز';
$string['switchphase'] = 'تغییر فاز';
$string['switchphase10'] = 'تعویض به مرحله راه‌اندازی';
$string['switchphase10info'] = 'شما در آستانهٔ بردن کارگاه به <strong>مرحله راه‌اندازی</strong> هستید. در این مرحله، کاربران قادر به تغییر کارها یا ارزشیابی‌هایی که صورت داده‌اند نیستند. اساتید می‌توانند از این مرحله برای تغییر تنظیمات کارگاه یا تغییر استراتژی نمره‌دهی در فرم‌های تغییر ارزشیابی استفاده کنند.';
$string['switchphase20'] = 'تعویض به مرحله تحویل';
$string['switchphase20info'] = 'شما در آستانهٔ بردن کارگاه به <strong>مرحله تحویل</strong> هستید. در این مرحله، شاگردان می‌توانند کارهایشان را (در صورت تعیین، در محدودهٔ تاریخ‌های تحویل) تحویل دهند. اساتید می‌توانند کارهای تحویل داده شده را برای بازبینی مجدد توسط فرد ثالث اختصاص دهند.';
$string['switchphase30'] = 'تعویض به مرحله ارزشیابی';
$string['switchphase30auto'] = 'کارگاه به طور اتوماتیک به مرحله ارزشیابی تعویض خواهد شد بعد از {$a->daydatetime} ({$a->distanceday})';
$string['switchphase30info'] = 'شما در آستانهٔ بردن کارگاه به <strong>مرحله ارزشیابی</strong> هستید. در این مرحله، بازبین‌ها می‌توانند به کارهای ارائه شده‌ای که به آن‌ها تفویض شده است را (در صورت تعیین، در محدودهٔ تاریخ‌های ارزشیابی) مورد ارزشیابی قرار دهند.';
$string['switchphase40'] = 'تعویض به مرحله نمره‌دهی';
$string['switchphase40info'] = 'شما در آستانهٔ بردن کارگاه به <strong>مرحله نمره‌دهی</strong> هستید. در این مرحله، کاربران نمی‌توانند کارها یا ارزشیابی‌هایشان را تغییر دهند. اساتید می‌توانند از ابزار بررسی نمره‌دهی برای محاسبهٔ نمره نهایی و آماده کردن بازخورد برای بازبین‌ها استفاده کنند.';
$string['switchphase50'] = 'بستن کارگاه';
...
$string['switchphasenext'] = 'تعویض به مرحله بعدی';
...
$string['taskconclusion'] = 'تهیه یک نتیجه‌گیری از فعالیت';
$string['taskdone'] = 'وظیفه انجام شد';
...
$string['userplan_help'] = 'طراح کارگاه، تمام مراحل مربوط به این فعالیت را نشان می‌دهد و کارهایی که در هر مرحله باید صورت بگیرد را لیست می‌کند. مرحله فعلی به صورت مشخص نمایش داده می‌شود و تکمیل کارها با یک علامت تیک مشخص می‌شود.';
$string['userplancurrentphase'] = 'مرحله جاری';
...
$string['workshop:deletesubmissions'] = 'حذف کار تحویل داده شده';
